class Activity < ApplicationRecord
  ...
  validates :location, presence: true, length: { maximum: 100, minimum: 5 }, format: { with: /\A[a-zA-Z0-9. ]+\z/ }
  validates :date, presence: true
  validates :description, presence: true, allow_blank: false
  validates :keywords, presence: true, length: { maximum: 50 }, format: { with: /\A[a-zA-Z]+\z/ }
